...
const _hoisted_4 = /* @__PURE__ */ createBaseVNode("h2", null, "Create Account", -1);
const _hoisted_5 = { class: "col-md-2" };
const _hoisted_6 = /* @__PURE__ */ createStaticVNode('<input id="username" type="text" value="" placeholder="Username" minlength="4" required><input id="password" type="password" value="" placeholder="Password" minlength="8" autocomplete="new-password" pattern="[0-9a-zA-Z.!#$%&amp;&#39;*+/=?^_`{|}~-]" required><input id="password2" type="password" value="" placeholder="Repeat Password" required><input id="emailIn" type="email" placeholder="Email Address" pattern="[a-zA-Z0-9.!#$%&amp;&#39;*+/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)" required><input id="phoneIn" type="tel" placeholder="Phone #" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" required>', 5);
